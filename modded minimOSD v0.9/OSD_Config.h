//Tracker Config
#define panServo_neutral           1465    //pwm at neutral
#define panServo_PWMdeg            4.9     //deg / pwm range
#define panServo_max               2150    
#define panServo_min               850

#define tiltServo_neutral          1300    //pwm at neutral
#define tiltServo_PWMdeg           6.5     //deg / pwm range
#define tiltServo_max              2000    
#define tiltServo_min              1000

#define AntTLP                     0.5     //low pass filter on pan, 0...1

#define tiltServo_pin              5       //connection pins for pwm out
#define panServo_pin               7

#define headingLock_switch         9       //input switch


#define videoRSSI_1		   0       //video rssi analog inputs
#define videoRSSI_2		   1
#define videoSwitch_1		   8       //digital outputs to video switch
#define videoSwitch_2		   10

#define videoTime_constant         250    //how many times the main loop runs before updating the diversity - too low and the video signal might get dirty from fast switching...
...
#define headingLock_zero_ADDR 301
#define videoRSSI_1_offset_ADDR 302
#define videoRSSI_2_offset_ADDR 303
