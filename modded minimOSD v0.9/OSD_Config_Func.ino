...
void readSettings() {
    ...
    headingLock_zero = EEPROM.read(headingLock_zero_ADDR)*2;
    videoRSSI_1_offset = EEPROM.read(videoRSSI_1_offset_ADDR)*2;
    videoRSSI_2_offset = EEPROM.read(videoRSSI_2_offset_ADDR)*2;
